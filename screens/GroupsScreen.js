    ...
    <SafeAreaView className="bg-white flex-1">
        ...
        <View className="items-center">
          <View className="mt-11">
            <TouchableOpacity className="flex justify-center bg-black active:bg-zinc-700 font-bold rounded-2xl h-28 w-60" onPress={() => Linking.openURL("https://tinyurl.com/" + postal)}>  
          ...
          <View className="mt-9">
            <TouchableOpacity className="flex justify-center bg-black active:bg-zinc-700 font-bold rounded-2xl h-28 w-60" onPress={() => Linking.openURL("https://tinyurl.com/carpl" + postal)}>
